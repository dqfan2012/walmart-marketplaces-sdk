 ...
 */
class UpdateInventory extends Core implements InventoryApiEndpointInterface
{
    /**
     *
     */
    public function sendRequest(string $accessToken, string $sku, string $xml)
    {
